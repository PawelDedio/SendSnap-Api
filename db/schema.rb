...
ActiveRecord::Schema.define(version: 20170215091439) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"
  enable_extension "uuid-ossp"

  create_table "chat_messages", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["author_id", "recipient_id"], name: "index_chat_messages_on_author_id_and_recipient_id", using: :btree
  end
  ...
  create_table "user_chat_subscriptions", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.uuid     "user_id"
    t.uuid     "participant_id"
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["participant_id"], name: "index_user_chat_subscriptions_on_participant_id", using: :btree
    t.index ["user_id"], name: "index_user_chat_subscriptions_on_user_id", using: :btree
  end

  create_table "user_devices", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.uuid     "user_id",         null: false
    ...
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["device_type"], name: "index_user_devices_on_device_type", using: :btree
    t.index ["user_id"], name: "index_user_devices_on_user_id", using: :btree
  end

  create_table "user_snaps", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.uuid     "user_id",                    null: false
